...
export class VeloMaggAvailabilitySettings extends Component {
    ...
    componentDidMount = () => {
        Axios.post("https://0.0.0.0:5000/services/openDataMontpellier/listVeloMaggParks", {
...
export default VeloMaggAvailabilitySettings
